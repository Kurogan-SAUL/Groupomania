...
<body>
    ...
    <form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="post">
        ...
        <input class="post-comment" type="submit" name="postComment<?php echo $post_id; ?>" value="Commenter" style="padding: 5px 10px 5px 10px; background: cornflowerblue; border: none; border-radius: 5px; color: white; margin-left: 10px; position: absolute; height: 28%;">     
    </form>
    ...
    <?php
        ...
        if($count != 0){
            while ($comment = mysqli_fetch_array($get_comments)){
                ...
                if($interval->y >= 1){
                    if($interval == 1)
                        $time_message = "Il y a " . $interval->y . " année";
                    else
                        $time_message = "Il y a " . $interval->y . " années";
                }
                    ...
                    if($interval->m == 1){
                        $time_message = "Il y a " . $interval->m . " mois" .
                        $days;
                    }
                    else{
                        $time_message = "Il y a " . $interval ->m . " mois".
                    ...
                    if($interval->s < 30){
                        ...
                        $time_message = "Il y a " . $interval->s . " seconds";
                    }
                }
