...
<body>
    ...
    <?php
        ...
        if($num_rows > 0){ //bouton j'aime plus
            ...
            echo '<form action="like.php?post_id='. $post_id . '" method="POST" style="position: absolute; top: 0;">
                    <input type="submit" class="comment_like" name="like_btn" value="Aimer" style="background: #3875C5; border: none; border-radius: 3px; padding: 3px 10px 3px 10px; color: white;">
                    <div class="like_value" style="display: inline;">
                        ('. $total_likes . ')
                    </div>
                </form>
