...
<body>
        ...
        <div class="signin-form">
            ...
            <div class="form-bottom">
                <form action="register.php" method="POST" class="login-form">
                    ...
                    <?php if(in_array("Email or Password was incorrect", $error_array_login)) echo "<p class='alert'>Email ou Mot de passe incorrect </p>"; ?>
                    <button type="submit" style="margin-bottom:20px" name="login_button">Se connecter</button>
                </form>     
            </div>
        </div>
        ...
        <div class="signup-form">
            ...
            <div class="form-bottom">
                <form action="register.php" method="POST">
                    ...
                    <!-- Boutton envoyer -->
                    <button type="submit"  style="margin-bottom:20px" name="reg_user" >Inscription!</button>         
    ...
    <footer>			
    	<div class="footer"> 
    		...
    		<p> ©2020 All Rights Reserved <BR> Website designed and developed by <strong><U>Gedeon DJAHOUI</u></strong></p>
    	</div>
    </footer>
